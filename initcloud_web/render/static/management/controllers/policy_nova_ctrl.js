...
CloudApp.controller('Policy_NovaController',
    ...
    .controller('NewPolicy_NovaController',
        ...
        function($rootScope, $scope, $modalInstance, $i18next,
                 policy_nova, policy_nova_table, Nova_Role, ngTableParams,
                 Policy_Nova, UserDataCenter, policy_novaForm, User, CheckboxGroup,
...
//		alert(roles)
		...
		var post_data = {"action":policy_nova.action, "roles":return_roles};

                CommonHttpService.post("/api/policy_nova/update/", post_data).then(function(data){
                    if (data.success) {
                        ToastrService.success(data.msg, $i18next("success"));
