...
1.各个文件的说明
   ...
   policy_nova_ctrl.js: 具体处理各项前端请求的js代码，所有的操作从这里发起。

   policy_nova.html: 具体模版 
...
3.部署应用
   ...
   j.add app in settings
      ...
      比如应用的名称是policy_nova,则添加biz.policy_nova
