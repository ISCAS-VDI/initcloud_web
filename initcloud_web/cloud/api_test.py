...
def tenant_create():
    t = keystone.tenant_create(None, name="ydd-test")
    print t
    return t

def user_create(t):
    u = keystone.user_create(None, name="yangdongdong",
                            email="yangdongdong@initcloud.com",
                            password="admin",
                            project=t.id)
...
def all_in_one():
    ...
    d = {"username": u.username,
         "password": "admin",
         "tenant_name": t.name,
         "auth_url": "http://192.168.223.101:5000/v2.0"}
